...
export type Profile = {id:string;nickname:string;avatar?:string;leaderboardEnabled?:boolean;participating:boolean;isTest:boolean;active:boolean;checkinDays?:string[];activityGoals?:ActivityGoal[]};
export type AdminPatient = Profile&{name:string;bound:boolean;deletedAt?:string|null;leaderboardVersion?:string|null;stateVersion?:string|null};
