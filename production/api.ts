...
export type Profile = {id:string;nickname:string;avatar?:string;leaderboardEnabled?:boolean;participating:boolean;isTest:boolean;active:boolean;activityGoals?:ActivityGoal[]};
